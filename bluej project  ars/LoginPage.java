...
public class LoginPage extends JFrame
{
	...
	final Object[] col1 = { "From", "To", "Price (Economy Class)", "Time" };
	final Object[] col2 = { "From", "To", "Price (Economy Class)", "Time" };
	final Object[] col3 = { "From", "To", "Price (Business Class)", "Time" };
	final Object[] col4 = { "From", "To", "Price (Business Class)", "Time" };


	final Object[][] row1 = { { "Mumbai", "Bangalore", "3125", "16:30" }, { "Mumbai", "Chennai ", "3225", "19:00" }, { "Mumbai", "Delhi", "1425 ", "08:30" }, { "Mumbai", "Goa", "1025 ", "09:50" }, { "Mumbai", "Hyderabad", "1525", "11:00" }, { "Mumbai", "Kolkata", "3825 ", "05:30" }, { "Mumbai", "Lucknow", "3025 ", "05:30" }, { "Mumbai", "Trivandrum", "1725", "12:00" }, { "Mumbai", "Vishakapatnam", "3725", "19:00" } };
	...
	final Object[][] row3 = { { "Mumbai", "Bangalore", "9375", "16:30" }, { "Mumbai", "Chennai ", "9675", "19:00" }, { "Mumbai", "Delhi", "4275", "08:30" }, { "Mumbai", "Goa", "3075", "09:50" }, { "Mumbai", "Hyderabad", "4575", "11:00" }, { "Mumbai", "Kolkata", "11475", "05:30" }, { "Mumbai", "Lucknow", "9075", "05:30" }, { "Mumbai", "Trivandrum", "5175", "12:00" }, { "Mumbai", "Vishakapatnam", "11175", "19:00" } };
	...
	JTable TInternationalFlight1 = new JTable(row4, col4);
	...
	Icon img1 = new ImageIcon("D:\\My work\\Airline-reservation-system-java-master\\img\\economy-ergonomical.png");
	Icon img2 = new ImageIcon("D:\\My work\\Airline-reservation-system-java-master\\img\\Air-France_COM-P066181--777-P.png");
	Icon img3 = new ImageIcon("D:\\\\My work\\\\Airline-reservation-system-java-master\\\\img\\\\economy-ergonomical.jpg.png");
	Icon img4 = new ImageIcon("D:\\\\My work\\\\Airline-reservation-system-java-master\\\\img\\\\Air-France_COM-P066181--777-P.png");
	...
	public LoginPage()
	{
		...
		setPreferredSize(new Dimension(816,602));
		...
		PFlightTypes.setBounds(10,0,500, 340);
		PLogin.setBounds(460,40,280, 280);
		PFlightDetails.setBounds(10,340,790,200);
...
{
	LoginPage type;
	char[] cCheck, cPassword={'r','o','h','a','n','\0'};
	JFrame f;
	String sCheck,sCheck1="rohan";
