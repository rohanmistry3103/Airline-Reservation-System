...
public class DomesticFlight extends JFrame
{
	...
	public DomesticFlight(LoginPage type1)
	{
		...
		String[] sItem2 ={ "Bangalore", "Chennai ", "Delhi", "Goa", "Hyderabad", "Kolkata", "Lucknow", "Trivandrum", "Vishakapatnam" };
		String[] sItem3={"Economic","Business"};
		
		
		this.type1 = type1;
		PPanel1 = new JPanel(null);
		PPanel1.setPreferredSize(new Dimension(480,300));
		...
		img1=new ImageIcon("D:\\My work\\Airline-reservation-system-java-master\\img\\flight map (1).png");
		...
		BFindFlight.setBounds(50,270,200,25);

		LImg1.setBounds(10,300,495,260);
		...
		PPanel2.setPreferredSize(new Dimension(330,160));
		...
		img2 = new ImageIcon("D:\\My work\\Airline-reservation-system-java-master\\img\\note_bg.gif");
		LImg2 = new JLabel(img2);
		LNotes = new JLabel("<html><body><p>NOTE: Bookings with International Credit Cards <p> have temporarily been suspended.Kindly carry<p>your RTPC-R report with you. Take necessary<p>precautions while travelling. We regret any<p>inconvenience caused to our passengers.</body></html>");
		...
		LImg2.setBounds(26,220,320,200);
...
class button3 implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(sClass.equals("Economic"))
		{
			...
			{
				JOptionPane.showMessageDialog(null, "You have no rights to access. Kindly login first!!");
				System.exit(0);
			}
		}
		else
